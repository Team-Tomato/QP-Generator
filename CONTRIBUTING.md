...
First off, thank you for considering contributing to ```QP-Generator```. This guide details all the general information that one should know before contributing to the project.
...
```
git clone https://github.com/<YOUR_USER_NAME>/QP-Generator.git
```
...
**1.** On GitHub navigate to the main page of the repository. [Here](https://github.com/Team-Tomato/QP-Generator.git) in this case.
